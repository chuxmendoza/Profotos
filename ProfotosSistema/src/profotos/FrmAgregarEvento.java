...
public class FrmAgregarEvento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Agregar Empleados");

        jLabel6.setText("Nombre del Empleado lider");

        jButton1.setText("+");

        jLabel7.setText("Nombre del Empleado");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Vendedor", "Fotografo" }));

        jLabel8.setText("Ventas");

        jLabel9.setText("pzas");

        jLabel10.setFont(new java.awt.Font("Euphemia", 0, 18)); // NOI18N
        jLabel10.setText("Agregar Inversión");

        jButton2.setText("+");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecciona la inversión", "Item 2", "Item 3", "Item 4" }));
